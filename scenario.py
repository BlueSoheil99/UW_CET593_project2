...
def scenario_base(network_type, volume_type, control_type, ped_phasing_val, pene_value):
    print("----Get parameters...")
    paras = set_parameters(network_type, volume_type, control_type, ped_phasing_val)
...
"""
network_type = "UW_intersection"
volume_type = "symmetric"
control_type = "fixed_time" # "multi_scale", "actuated", "fixed_time"
